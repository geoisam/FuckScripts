...
| **魔都** | <https://moduzy2.com/api.php/provide/vod/from/mdm3u8/> | `站点搜索关闭` |
| **最大** | <https://api.zuidapi.com/api.php/provide/vod/from/zdm3u8/> | `站点搜索关闭` |
...
| **樱花** | <https://m3u8.apiyhzy.com/api.php/provide/vod/from/yhm3u8/> | `站点搜索关闭` |
